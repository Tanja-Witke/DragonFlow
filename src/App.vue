        ...
        <div class="flex-1 overflow-hidden">
          ...
          <div v-if="tab==='lists'" class="h-full">
            <section class="h-full">
              ...
              <!-- tasks (active only) -->
              <ul class="flex-1 overflow-y-auto overflow-x-hidden scrollbar-left pl-1 pb-2 vlist">
                <li
                ...
                <!-- inline add row as part of the list -->
                <li :id="'add-anchor-'+list.id" class="group relative flex items-center gap-2 px-2 py-1 task-item muted-tile mt-1 snap-start" @click="toggleAddMenu(list.id)">
                  <div class="order-1 w-7 shrink-0" style="margin-left:-8px"></div>
                  <div class="order-2 flex items-center gap-2 text-muted">
                  ...
                  <div class="order-3 w-5 shrink-0"></div>

                  <!-- anchored add menu -->
                  <div
                    v-if="ui.listAddMenuId===list.id"
                    :id="'add-menu-'+list.id"
                    class="menu-fab space-y-2"
                    :style="addMenuStyle(list.id)"
                  >
                    ...
                    <div v-if="ui.addMode==='task'" class="space-y-2">
                      ...
                      <div class="flex justify-end gap-2">
                        <button class="btn-outline" @click.stop="toggleAddMenu(null)">Close</button>
